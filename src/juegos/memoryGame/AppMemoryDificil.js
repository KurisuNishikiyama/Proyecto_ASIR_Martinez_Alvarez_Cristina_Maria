...
class AppMemoryDificil extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Baraja: ConstruirBaraja(12),
      ParejaSeleccionada: [],
  ...
  render() {
    console.log("AppMemoryDificil",this.state.Baraja);
    return (
      <div className='App'>
...
//          alert("¡Enhorabuena!")  
  ...
  resetear() {
    this.setState({ Baraja: ConstruirBaraja(12), ParejaSeleccionada: [], CompararCartas: false, numeroIntentos: 0 })
  }

};

export default AppMemoryDificil;