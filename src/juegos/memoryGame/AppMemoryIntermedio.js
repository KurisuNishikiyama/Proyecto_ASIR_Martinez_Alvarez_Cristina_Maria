...
class AppMemoryIntermedio extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Baraja: ConstruirBaraja(10),
      ParejaSeleccionada: [],
  ...
  render() {
    console.log("AppMemoryIntermedio",this.state.Baraja);
    return (
      <div className='App'>
        <Header numeroIntentos={this.state.numeroIntentos} resetear={() => this.resetear()} />
...
//          alert("¡Enhorabuena!")  
  ...
  resetear() {
    this.setState({ Baraja: ConstruirBaraja(10), ParejaSeleccionada: [], CompararCartas: false, numeroIntentos: 0 })
  }

};

export default AppMemoryIntermedio;